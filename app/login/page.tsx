...
import { Mail, Lock, Eye, Facebook, Chrome } from "lucide-react"
import { Button } from "@/components/ui/button"
import { Input } from "@/components/ui/input"
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card"

export const metadata: Metadata = {
  title: "Đăng nhập - MSC Center",
  description: "Đăng nhập vào tài khoản MSC Center để truy cập các khóa học và dịch vụ",
}
              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <Input id="password" type="password" placeholder="Nhập mật khẩu" className="pl-10 pr-10" required />
                    <button
                      type="button"
