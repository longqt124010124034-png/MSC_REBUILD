          ...
          >
            ...
            <div className="space-y-4 ">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-blue-100">Hotline: (+84) 329 381 489</p>
                  <p className="text-blue-100">Mobile: (+84) 329 381 489</p>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-10 h-10 bg-teal-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <p className="text-blue-100">msc.edu.vn@gmail.com</p>
              </div>
            </div>
          </motion.div>
      ...
      <div className="relative z-10 border-t border-white/20 bg-black/20 backdrop-blur-sm">
        <div className="container py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-blue-200 text-sm">© 2025 MSC Center. Phát triển bởi Phòng Công nghệ thông tin</p>
